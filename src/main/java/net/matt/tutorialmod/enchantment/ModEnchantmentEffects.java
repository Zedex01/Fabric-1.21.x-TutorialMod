package net.matt.tutorialmod.enchantment;

import com.mojang.serialization.MapCodec;
import net.matt.tutorialmod.TutorialMod;
import net.matt.tutorialmod.enchantment.custom.LightningStrikerEnchantmentEffect;
...
public class ModEnchantmentEffects {
    ...
    public static void registerEnchantmentEffects(){
        TutorialMod.LOGGER.info("Registering Enchantments from " + TutorialMod.MOD_ID);
    }
}
