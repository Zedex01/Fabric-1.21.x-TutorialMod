...
public class ModRegistriesDataGenerator extends FabricDynamicRegistryProvider {
    public ModRegistriesDataGenerator(FabricDataOutput output, CompletableFuture<RegistryWrapper.WrapperLookup> registriesFuture) {
