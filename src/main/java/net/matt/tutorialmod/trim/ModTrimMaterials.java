package net.matt.tutorialmod.trim;
...
public class ModTrimMaterials {
    //Register the Armor Trim Material
    ...
    public static void bootstrap(Registerable<ArmorTrimMaterial> registerable){
        register(registerable, PINK_GARNET, Registries.ITEM.getEntry(ModItems.PINK_GARNET),
                Style.EMPTY.withColor(TextColor.parse("#b03fe0").getOrThrow()), 1.0f);//Item model index changes color that is -
        // - displayed on the model. Goes from 0.1f, to 1.0f
    }
